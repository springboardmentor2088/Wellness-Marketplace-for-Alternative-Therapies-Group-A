    ...
    const checkVerificationStatus = async () => {
      try {
        ...
        if (onboardingStatus.onboardingCompleted) {
          // Sync onboardingCompleted flag in stored user object to prevent redirect loop
        ...
        // ✅ THIS ENSURES SPINNER STOPS ALWAYS
        setLoading(false);
      }
    };
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full mt-2 px-4 py-3 border rounded-lg focus:ring-2 focus:outline-none ${errors.licenseNumber ? 'border-red-500 focus:ring-red-500' : 'focus:ring-[#1f6f66]'
                          }`}
                        required
                      />
                ...
                <div className="bg-gray-50 p-5 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full mt-2 px-4 py-3 border rounded-lg focus:ring-2 focus:outline-none ${errors.specialization ? 'border-red-500 focus:ring-red-500' : 'focus:ring-[#1f6f66]'
                          }`}
                        required
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full mt-2 px-4 py-3 border rounded-lg focus:ring-2 focus:outline-none ${errors.yearsOfExperience ? 'border-red-500 focus:ring-red-500' : 'focus:ring-[#1f6f66]'
                          }`}
                        required
                      />
                  ...
                  <div className="mb-4">
                    ...
                    <textarea
                      ...
                      className={`w-full mt-2 px-4 py-3 border rounded-lg focus:ring-2 focus:outline-none ${errors.qualifications ? 'border-red-500 focus:ring-red-500' : 'focus:ring-[#1f6f66]'
                        }`}
                      rows="2"
                      required
                    />
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className={`w-full mt-2 px-4 py-3 border rounded-lg focus:ring-2 focus:outline-none ${errors.bio ? 'border-red-500 focus:ring-red-500' : 'focus:ring-[#1f6f66]'
                        }`}
                      rows="4"
                      required
                    />
                ...
                <div className="bg-gray-50 p-5 rounded-lg">
                  ...
                  <div className="mb-4">
                    ...
                    <textarea
                      ...
                      className={`w-full mt-2 px-4 py-3 border rounded-lg focus:ring-2 focus:outline-none ${errors.clinicAddress ? 'border-red-500 focus:ring-red-500' : 'focus:ring-[#1f6f66]'
                        }`}
                      rows="2"
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full mt-2 px-4 py-3 border rounded-lg focus:ring-2 focus:outline-none ${errors.consultationFee ? 'border-red-500 focus:ring-red-500' : 'focus:ring-[#1f6f66]'
                        }`}
                      required
                    />
