...
export default function BookingForm({ practitionerId, practitionerName, consultationFee, selectedSlot, onSuccess, onClose }) {
    const feeAmount = consultationFee != null ? Number(consultationFee) : 0;
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 relative animate-fade-in">
              ...
              ${sessionType === type
                    ...
                    <div className="flex gap-3">
                        ...
                        >
                            {loading ? "Holding Slot..." : `Proceed to Pay (₹${feeAmount.toFixed(2)})`}
                        </button>
                    </div>
                </>
            </div>
